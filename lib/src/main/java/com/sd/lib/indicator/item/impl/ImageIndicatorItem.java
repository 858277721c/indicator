...
public class ImageIndicatorItem extends FrameLayout implements IndicatorItem
{
    public ImageIndicatorItem(Context context)
    {
        super(context);
        init();
    }

    public ImageIndicatorItem(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init();
    }

    public ImageIndicatorItem(Context context, AttributeSet attrs, int defStyleAttr)
    {
